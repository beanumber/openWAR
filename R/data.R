...
#' Final openWAR values for 2013.
#' 
#' A dataset containing computed openWAR values for MLB players during the 2013 season along with
#' the runs above average for each component of openWAR.    
#' 
#' @format An `openWARPlayers` object, which is also a \code{data.frame} with 1303
#' rows (e.g. a player) and 41 columns. The columns are as follows:
#' \describe{
#'    \item{playerId}{the MLBAM id of the player}
#'    \item{batterId}{the MLBAM id of the batter}
...
#' Final openWAR values for 2014.
#' 
#' A dataset containing computed openWAR values for MLB players during the 2014 season along with
#' the runs above average for each component of openWAR.    
#' 
#' @format An `openWARPlayers` object, which is also a \code{data.frame} with 1320
#' rows (e.g. a player) and 41 columns. The columns are as follows:
#' \describe{
#'    \item{playerId}{the MLBAM id of the player}
#'    \item{batterId}{the MLBAM id of the batter}
