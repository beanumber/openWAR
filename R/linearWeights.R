...
getLinearWeightsModel = function(type) {
    all.events = c("Balk", "Batter Interference", "Batter Turn", "Bunt Groundout", "Bunt Lineout", "Bunt Pop Out", "Catcher Interference", 
        "Caught Stealing 2B", "Caught Stealing 3B", "Caught Stealing Home", "Defensive Indiff", "Defensive Sub", "Defensive Switch", 
        "Double", "Double Play", "Ejection", "Error", "Fan interference", "Field Error", "Fielders Choice", "Fielders Choice Out", 
        "Flyout", "Forceout", "Game Advisory", "Grounded Into DP", "Groundout", "Hit By Pitch", "Home Run", "Intent Walk", "Lineout", 
        "Offensive sub", "Passed Ball", "Picked off stealing 2B", "Picked off stealing 3B", "Picked off stealing home", "Pickoff 1B", 
        "Pickoff 2B ", "Pickoff 3B", "Pickoff Error 1B", "Pickoff Error 2B", "Pickoff Error 3B", "Pitching Substitution", "Player Injured", 
        "Pop Out", "Runner Advance", "Runner Out", "Sac Bunt", "Sac Fly", "Sac Fly DP", "Sacrifice Bunt DP", "Single", "Stolen Base 2B", 
        "Stolen Base 3B", "Strikeout", "Strikeout - DP", "Triple", "Triple Play", "Umpire Substitution", "Walk", "Wild Pitch")
    if (type == "xr") {
        event = c("Home Run", "Triple", "Double", "Single", "Walk", "Hit By Pitch", "Intent Walk", "Grounded Into DP", "Sac Fly", 
            "Sac Bunt", "Strikeout", "Strikeout - DP")
        bip.outs = c("Bunt Groundout", "Bunt Lineout", "Bunt Pop Out", "Error", "Field Error", "Fielders Choice", "Fielders Choice Out", 
            "Flyout", "Forceout", "Groundout", "Lineout", "Pop Out", "Sac Fly DP", "Sacrifice Bunt DP", "Triple Play")
