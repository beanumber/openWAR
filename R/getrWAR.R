...
getrWAR <- function() {
    ...
    rWAR <- rename(rWAR, rRAA_bat = runs_above_avg_off, rRAA_field = runs_above_avg_def, rRAA_pitch = runs_above_avg.y, playerId = player_ID, 
        yearId = year_ID, stintId = stint_ID)
